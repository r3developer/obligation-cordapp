...
public class IOUIssueTests {
     ...
     * - We usually encapsulate our commands in an interface inside the contracts class called {@link Commands} which
    ...
    /**
     * Task 2.
     * As previously observed, issue transactions should not have any input states references. Therefore we must check to
     * ensure that no input states are included in a transaction to issue an IOU.
     * TODO: Write a contracts constraint that ensures a transaction to issue an IOU does not include any input states.
     ...
     *     });
     *
     * Note that the unit tests often expect contracts verification failure with a specific message which should be
     * defined with your contracts constraints. If not then the unit test will fail!
     *
     ...
     * TODO: Write a contracts constraint that ensures only one output states is created in a transaction.
     ...
     * positive value.
     * TODO: Write a contracts constraint that ensures newly issued IOUs always have a positive value.
     * Hint: You will need a number of hints to complete this task!
     * - Create a new constant which will hold a reference to the output IOU states.
     ...
     *
     *       XState states = (XState)tx.getOutputStates().get(0)
     *
     ...
     * TODO: Add a contracts constraint to check the lender is not the borrower.
     * Hint:
     ...
     * TODO: Add a contracts constraint to check that all the required signers are {@link IOUState} participants.
     * Hint:
     ...
     * value to a constant.
     * - Next, you will need to retrieve the participants of the output states and ensure they are equal them.
     *
     * Java Hints
